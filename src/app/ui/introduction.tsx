...
export default function Introduction() {
  ...
  return (
    <div className="flex flex-col place-items-center space-y-8">
      ...
      />
      <span className={`text-4xl text-center ${notoSans.className} antialised`}>Mahadev Maitri</span>
      ...
      <Link href="/resume.pdf" target="_blank" className="download-resume mt-12 text-xl text-center font-semibold">
        Download Resume
      </Link>
